...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['student_id'], ['users.id'], name=op.f('fk_llm_usage_logs_student_id'), ondelete='cascade'),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['student_id'], ['users.id'], name=op.f('fk_premium_usage_quotas_student_id'), ondelete='cascade'),
