#!/usr/bin/env python3
"""
Validation script for progress-motivator skill.
...
def validate_skill():
    """Validate the progress-motivator skill structure."""
    ...
    print("Validating progress-motivator skill...")
    ...
    if 'name: progress-motivator' not in content:
        print("[ERROR] Skill name is not 'progress-motivator'")
        return False
    ...
    # All checks passed
    print("[SUCCESS] progress-motivator skill validated successfully!")
    print(f"  - SKILL.md: {skill_md}")
    print(f"  - Name: progress-motivator")
    print(f"  - Description: Progress tracking and motivation")
    return True
