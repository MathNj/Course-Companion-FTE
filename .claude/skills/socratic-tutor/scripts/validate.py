#!/usr/bin/env python3
"""
Validation script for socratic-tutor skill.
...
def validate_skill():
    """Validate the socratic-tutor skill structure."""
    ...
    print("Validating socratic-tutor skill...")
    ...
    if 'name: socratic-tutor' not in content:
        print("[ERROR] Skill name is not 'socratic-tutor'")
        return False
    ...
    # All checks passed
    print("[SUCCESS] socratic-tutor skill validated successfully!")
    print(f"  - SKILL.md: {skill_md}")
    print(f"  - Name: socratic-tutor")
    print(f"  - Description: Socratic questioning tutor")
    return True
