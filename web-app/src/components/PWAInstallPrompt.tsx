...
export function PWAInstallPrompt() {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 md:left-auto md:right-4 md:w-96 z-50 animate-fade-in-up">
      <div className="bg-zinc-900 border border-cyan-800 rounded-xl p-4 shadow-2xl">
        {/* Close Button */}
        <button
        ...
        <div className="mt-4 pt-4 border-t border-cyan-800">
          <div className="grid grid-cols-3 gap-2 text-center">
            <div>
              <div className="text-cyan-400 font-semibold">Fast</div>
              <div className="text-xs text-zinc-500">Instant load</div>
            </div>
            <div>
              <div className="text-cyan-400 font-semibold">Offline</div>
              <div className="text-xs text-zinc-500">Works offline</div>
            </div>
            <div>
              <div className="text-cyan-400 font-semibold">Native</div>
...
export function NetworkStatus() {
  ...
  return (
    <div className="fixed top-20 left-1/2 transform -translate-x-1/2 z-50 animate-fade-in">
      <div className="bg-zinc-800 border border-cyan-700 rounded-lg px-4 py-2 flex items-center gap-2 shadow-lg">
